<?php 
class ModelExtensionPaymentAsiabillWechatpay extends Model {

  	public function getMethod($address) {

  		$helper = new Asiabill\Helper();
  		$code = $helper->payMethodCode('wechat');
        ...
        $logo = '';
      	...
      	if( $this->config->get('payment_asiabill_general_logo_type') == '1' ){
            $logo = '<img src="catalog/view/theme/default/image/asiabill/wechat.png">';
		}
