...
class ControllerExtensionPaymentAsiabillAlipay extends Controller {
    ...
    public function __construct($registry)
    {
        ...
        $this->code = $helper->payMethodCode('ali');
    ...
    public function index(){
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $post_data = self::checkParameter()) {
