...
class ControllerExtensionPaymentAsiabillDana extends Controller {
    ...
    public function __construct($registry)
    {
        ...
        $this->code = $helper->payMethodCode('DANA');
    ...
    private function checkParameter(){
        ...
        $mer_no = $this->request->post['payment_'.$this->code.'_'.$test.'mer_no'];
        $gateway_no = $this->request->post['payment_'.$this->code.'_'.$test.'gateway_no'];
        ...
        if( empty($this->request->post['payment_'.$this->code.'_'.$test.'key']) ){
