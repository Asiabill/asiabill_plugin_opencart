...
class ControllerExtensionPaymentAsiabillCreditcard extends Controller {
    ...
    public function __construct($registry)
    {
        ...
        $this->code = $helper->payMethodCode('cc');
    ...
    private function cardTypeSettings(){
        ...
        foreach ($card_arr as $key => $value){
            $settings[] = array(
                ...
                'description' => '',
                'value' => $this->asiabill_data->getValue('payment_'.$this->code.'_'.$key,'0')
            );
        }
        return $settings;
    }
